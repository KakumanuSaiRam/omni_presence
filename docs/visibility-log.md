...
| Date | Platform | Query | Result (3/1/0) | Notes |
|---|---|---|---|---|
| 2026-09-01 | Google (web) | "Siva tuitions Guntur" | 1 | Only directory listings (UrbanPro, LocalVyaparHub, AnyJankari) + Play Store app. No own site (domain was parked). Inconsistent addresses across listings. |
